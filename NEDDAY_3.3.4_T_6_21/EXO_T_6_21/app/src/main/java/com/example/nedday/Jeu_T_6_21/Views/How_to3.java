...
public class How_to3 extends Screen {
    ...
    public How_to3(Game game, Mylogic logic, MyGameActivity_play game_activity) {
        super(game);
        this.logic = logic;
    ...
    private void putPlaceHolders(){
        ...
        sprite =new MySprite_learn(game, Learn3_Assets.im3_10,(int)(game.getScreenWidth()/2.54) ,(int)(game.getScreenHeight()/6.4),(int)(game.getScreenHeight()/6.4),(int)(game.getScreenWidth()/4.32));
        addSprite(sprite);
    ...
    public void handleDragging(int x, int y, int pointer) {
        ...
        if ((s == home ) && !(manager.isMusicActive())) {
            ...
            game_activity.setScreen(new MyScreen3(game,logic, game_activity));
