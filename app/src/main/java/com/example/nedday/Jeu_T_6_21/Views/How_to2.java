...
public class How_to2 extends Screen {
    ...
    private MySprite_learn home,garcon;
    ...
    public How_to2(Game game, Mylogic logic, MyGameActivity_play game_activity) {
        super(game);
        this.logic = logic;
    ...
    private void putPlaceHolders(){
        ...
        sprite =new MySprite(game,Learn2_Assets.im2_5,(int)(game.getScreenWidth()/2.54) ,(int)(game.getScreenHeight()/6.4),(int)(game.getScreenHeight()/6.4),(int)(game.getScreenWidth()/4.32));
        addSprite(sprite);
    ...
    public void handleDragging(int x, int y, int pointer) {
        ...
        if ((s == home ) && !(manager.isMusicActive())) {
            ...
            game_activity.setScreen(new MyScreen2(game,logic, game_activity));
