...
public class Learn_Fruits_Screen extends Screen {
    ...
    public Learn_Fruits_Screen(Game game, Mylogic logic, MyGameActivity game_activity) {
        super(game);
    ...
    private void putPlaceHolders(){
        ...
        addSprite(teacher);
        sprite0=new MySprite_learn(game,Learn_Assets.im_7,1*w_unit,1*h_unit,(int)(game.getScreenHeight()/5),(int)(game.getScreenWidth()/4.25));
        addSprite(sprite0);
        sprite1=new MySprite_learn(game,Learn_Assets.im_8,4*w_unit,1*h_unit,(int)(game.getScreenHeight()/5),(int)(game.getScreenWidth()/4.25));
        addSprite(sprite1);
        sprite2=new MySprite_learn(game,Learn_Assets.im_9,8*w_unit,1*h_unit,(int)(game.getScreenHeight()/5),(int)(game.getScreenWidth()/4.25));
        addSprite(sprite2);
        sprite8=new MySprite_learn(game,Learn_Assets.im_15,8*w_unit,4*h_unit,(int)(game.getScreenHeight()/5),(int)(game.getScreenWidth()/4.25));
        addSprite(sprite8);
        sprite4=new MySprite_learn(game,Learn_Assets.im_11,4*w_unit,4*h_unit,(int)(game.getScreenHeight()/5),(int)(game.getScreenWidth()/3.5));
        addSprite(sprite4);
        sprite5=new MySprite_learn(game,Learn_Assets.im_12,(int)(game.getScreenWidth()/18),4*h_unit,(int)(game.getScreenHeight()/5),(int)(game.getScreenWidth()/4.25));
        addSprite(sprite5);
        sprite6=new MySprite_learn(game,Learn_Assets.im_13,(int)(game.getScreenWidth()/18),7*h_unit,(int)(game.getScreenHeight()/5),(int)(game.getScreenWidth()/4.25));
        addSprite(sprite6);
        sprite7=new MySprite_learn(game,Learn_Assets.im_14,4*w_unit,7*h_unit,(int)(game.getScreenHeight()/5),(int)(game.getScreenWidth()/4.25));
        addSprite(sprite7);
        sprite3=new MySprite_learn(game,Learn_Assets.im_10,4*w_unit,10*h_unit,(int)(game.getScreenHeight()/5),(int)(game.getScreenWidth()/4.25));
        addSprite(sprite3);
    ...
    public void handleTouchDown(int x, int y, int pointer) {
        ...
        if (PopupActivity.langue==0){
            ...
            if (s==sprite0 && !(manager.isMusicActive()))
            {
                ...
                Voice.im_fr_7.play(1);

            }
            if (s==sprite1  && !(manager.isMusicActive()))
            {Voice.im_fr_8.play(1);}

            if (s==sprite2  && !(manager.isMusicActive()))
            {Voice.im_fr_9.play(1);}
            if (s==sprite3  && !(manager.isMusicActive()))
            {Voice.im_fr_10.play(1);}
            if (s==sprite4  && !(manager.isMusicActive()))
            {Voice.im_fr_11.play(1);}
            if (s==sprite5  && !(manager.isMusicActive()))
            {Voice.im_fr_12.play(1);}
            if (s==sprite6  && !(manager.isMusicActive()))
            {Voice.im_fr_13.play(1);}
            if (s==sprite7  && !(manager.isMusicActive()))
            {Voice.im_fr_14.play(1);}
            if (s==sprite8  && !(manager.isMusicActive()))
            {Voice.im_fr_15.play(1);}
        ...
        if (PopupActivity.langue==2){
            ...
            if (s==sprite0 && !(manager.isMusicActive()))
            {
                ...
                Voice.im_ang_7.play(1);

            }
            if (s==sprite1  && !(manager.isMusicActive()))
            {Voice.im_ang_8.play(1);}

            if (s==sprite2  && !(manager.isMusicActive()))
            {Voice.im_ang_9.play(1);}
            if (s==sprite3  && !(manager.isMusicActive()))
            {Voice.im_ang_10.play(1);}
            if (s==sprite4  && !(manager.isMusicActive()))
            {Voice.im_ang_11.play(1);}
            if (s==sprite5  && !(manager.isMusicActive()))
            {Voice.im_ang_12.play(1);}
            if (s==sprite6  && !(manager.isMusicActive()))
            {Voice.im_ang_13.play(1);}
            if (s==sprite7  && !(manager.isMusicActive()))
            {Voice.im_ang_14.play(1);}

            if (s==sprite8  && !(manager.isMusicActive()))
            {Voice.im_ang_15.play(1);}
